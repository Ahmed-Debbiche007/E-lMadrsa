...
public class QuestionsScreenController implements Initializable {
    ...
    private void setNextQuestion() {
        ...
        System.out.println("size : " + questionList.size() + "number of r a" + this.numberOfRightAnswers);
        System.out.println("******** current question : " + this.currentQuestion);

        if (!(currentIndex >= questionList.size())) {
            this.currentQuestion = this.questionList.get(currentIndex);
            System.out.println("******** current question : " + this.currentQuestion);
            System.out.println("******** all questions : " + this.questionList);
    ...
    private void submit(ActionEvent event) throws IOException, DocumentException {
        ...
        try {
            ...
            try {
                PdfWriter.getInstance(Doc, new FileOutputStream("/home/ahmed/PiDev/E-lMadrsa-Web/public/uploads/images/result"+examen.getIdExamen()+p.getIdParticipation()+".pdf"));
                ...
                Doc.add(new Paragraph("Résultat : " + d));
                ...
                Doc.add(new Paragraph("\n "));
                Doc.close();
                Desktop.getDesktop().open(new File("/home/ahmed/PiDev/E-lMadrsa-Web/public/uploads/images/result"+examen.getIdExamen()+p.getIdParticipation()+".pdf"));
